...
log = logging.getLogger("example_dag_03")
...
def test_lightgbm(*args, **kwargs):
	...
	df_train = pd.read_csv(os.environ['AIRFLOW_HOME'] + '/dags/demo3/regression.train', header=None, sep='\t')
	df_test = pd.read_csv(os.environ['AIRFLOW_HOME'] + '/dags/demo3/regression.test', header=None, sep='\t')
